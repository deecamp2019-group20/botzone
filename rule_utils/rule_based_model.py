...
def choose_action(state):
    ...
    min_oppo_crads = min(left_cards[1], left_cards[2]) if state.player_role == 0 else left_cards[0]
    ...
    # 输出 player i [手牌] // [出牌]
    #print("Player {}".format(self.player_id), ' ', Card.visual_card(hand_card), ' // ', Card.visual_card(move))
    return move
